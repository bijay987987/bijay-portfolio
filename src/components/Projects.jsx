...
const ProjectCard = memo(({ project }) => {
  return (
    <motion.div
      ...
      className="bg-white/90 dark:bg-neutral-900/80 border border-neutral-200 dark:border-neutral-700 rounded-2xl shadow p-6 flex flex-col h-full max-w-2xl mx-auto"
    >
  ...
  const projectsData = useMemo(
    () => [
      { 
        ...
        desc: "A full-featured web application for managing employee records, attendance, leaves, and performance tracking. Built with a responsive interface and robust backend for seamless HR operations. The system uses PHP for server-side logic, MySQL for database management, and Bootstrap for a clean, responsive UI.", 
        tags: ["PHP", "MySQL", "Bootstrap", "JavaScript", "HTML", "CSS"], 
        links: [
          { type: "code", href: "https://github.com/bijay987987/Employee-Management-System" }
        ] 
      },
    ],
    []
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex flex-col items-center text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-center mb-10">
                Here is my project that I've worked on. It demonstrates my skills in full-stack web development using PHP, MySQL, and frontend technologies.
            </p>
        </motion.div>
