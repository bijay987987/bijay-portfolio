...
const SOCIAL_LINKS = [
  {
    href: "https://github.com/bijay987987",
    icon: <Github className="w-5 h-5" />,
    title: "GitHub",
  },
  {
    href: "https://www.linkedin.com/in/bijay-sarki-10a0a2419/",
    icon: <Linkedin className="w-5 h-5" />,
    title: "LinkedIn",
  },
  {
    href: "mailto:bijay987987@gmail.com",
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-12 w-full max-w-5xl px-4 py-12">
        ...
        >
          ...
          <div className="flex items-center justify-center md:justify-start gap-2 text-muted-foreground text-sm mb-2">
            ...
            <span>BITM (BMC) Bhaktapur</span>
          </div>

          <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-xl mb-4 text-center md:text-left">
            I'm a {" "}
            <span className="text-foreground font-medium">
              Bachelor of Information Technology Management (BITM) student
            </span>{" "}
            who has recently completed the 7th semester and is actively seeking
            internship opportunities in software and web development.
            <br />
           <br />
  Throughout my academic journey, I have worked on various projects and
  continuously explored modern technologies to strengthen my development
  skills. I am passionate about building user-friendly web applications,
  learning new technologies, and applying my knowledge to solve
