...
// --- Updated Static Data (Removed C++, SFML, Jupyter Notebook, Sublime Text) ---
const SKILLS_SECTIONS = [
    { 
      icon: <Code className="w-6 h-6" />, 
      title: "Programming Languages", 
      tags: ["C", "Java", "JavaScript", "Python", "HTML", "CSS"] 
    },
    { 
      icon: <Layers className="w-6 h-6" />, 
      title: "Frameworks & Libraries", 
      tags: ["React", "Tailwind CSS", "NumPy", "Pandas", "Bootstrap", "PHP"] 
    },
    { 
      icon: <Terminal className="w-6 h-6" />, 
      title: "Tools & Platforms", 
      tags: ["Git", "GitHub", "VS Code", "MySQL"] 
    },
    { 
      icon: <Sparkles className="w-6 h-6" />, 
      title: "Interests", 
      tags: ["Web Development", "Full-Stack Development", "Database Management", "UI/UX Design"] 
    },
];
