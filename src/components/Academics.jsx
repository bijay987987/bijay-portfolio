...
const ACADEMICS_DATA = [
 {
    ...
    alt: "Bhaktapur Multiple Campus Logo",
    title: "Bhaktapur Multiple Campus",
    link: "#",
    program: "Bachelor of Information Technology Management (BITM)",
    year: "2022 - Present",
    scoreLabel: "Status",
    score: "Completed 7th Semester",
  },
  {
    logo: "/assets/logos/khwopa.png",
    alt: "Khwopa College Logo",
    title: "Khwopa College",
    link: "https://khwopacollege.edu.np/",
    program: "computer Science /Higher Secondary Education (+2)",
    year: "2020 - 2021",
    scoreLabel: "CGPA",
    score: "2.87/4",
  },
  {
    logo: "/assets/logos/himalayan.png",
    alt: "Himalayan English Secondary School Logo",
    title: "Himalayan English Secondary School",
    link: "#",
    program: "Secondary Education (class X)",
    year: "2019",
    scoreLabel: "CGPA",
    score: "3.55/4",
  },
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex flex-col items-center text-center">
            ...
            <motion.p variants={itemVariants} className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10">
                My academic journey in Information Technology Management has provided me
with a strong foundation in programming, database management, web
development, software engineering, and modern technologies. Here are the
academic institutions that have contributed to my growth and learning.
            </motion.p>
        </motion.div>
